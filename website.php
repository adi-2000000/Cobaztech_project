...
?>
   ...
   //  </form></li>';
      ...
      <div class="furnitures_section layout_padding">
         <div class="container">
            <h2 class="our_text">WebSite Development</h2>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="container_main">
                        <img src="images/web-development1.png" alt="Avatar" class="image" style="width: 500px; height: 400px;">
                        <!-- <div class="overlay">
 ...
 if($row["package_name"] == "Basic" &&  $row["type"] == "website") {
    ...
    ?>
                                ...
                                <ul>
                                    <li><?php echo $numberOfPages ?></li>
                                    <li><?php echo $description ?></li>
                                    <li><?php echo $price ?></li> <!-- Replace XXX with the actual price -->
...
<a href="form.php?id=<?php echo $id; ?>" class="btn btn-primary custom-button" style="background-color: #0a9dad; color: #fff; text-decoration: none; padding: 10px 120px; border-radius: 5px;">Select</a>
    ...
    if ($result->num_rows > 0) {
        // Output data for each row
        while ($row = $result->fetch_assoc()) {
 if($row["package_name"] == "Standard"  && $row["type"] == "website") {
...
<a href="form.php?id=<?php echo $id; ?>" class="btn btn-primary custom-button" style="background-color: #0a9dad; color: #fff; text-decoration: none; padding: 10px 120px; border-radius: 5px;">Select</a>
    ...
    if ($result->num_rows > 0) {
        // Output data for each row
        while ($row = $result->fetch_assoc()) {
 if($row["package_name"] == "Premium" &&  $row["type"] == "website") {
