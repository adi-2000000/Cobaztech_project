...
?>
   ...
   //  </form></li>';
      ...
      <div class="furnitures_section layout_padding">
         <div class="container">
            <h2 class="our_text">Website Development+Digital marketing</h2>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="container_main">
                        <img src="images/web+digital2.jpg" alt="Avatar" class="image" style="width: 500px; height: 400px;">
                        <div class="overlay">
 ...
 if($row["package_name"] == "Basic" &&  $row["type"] == "websitedigital") {
    ...
    if ($result->num_rows > 0) {
        // Output data for each row
        while ($row = $result->fetch_assoc()) {
 if($row["package_name"] == "Standard"  && $row["type"] == "websitedigital") {
    ...
    if ($result->num_rows > 0) {
        // Output data for each row
        while ($row = $result->fetch_assoc()) {
 if($row["package_name"] == "Premium" &&  $row["type"] == "websitedigital") {
